 ...
 */
import "cipherguard-mad/net/ajax";
...
const getData = function(scenario) {
  switch (scenario) {
    case 'carol-email-updated':
      var user = data.filter(item => item.username == 'carol@cipherguard.com')[0];
      user.email = 'carol-updated@cipherguard.com';
      user.active = 0;
      break;
